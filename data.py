...
def create_image_processing_folders(image_preprocessing=no_preprocessing):
    ...
    assert os.path.exists(original_train), 'no_preprocessing/train should exist. Add original training images ' \
                                           'and labels to this file '
    assert os.path.exists(original_validation), 'no_preprocessing/train should exist. Add original validation ' \
                                                'images and labels to this file '
